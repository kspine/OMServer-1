    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">容器列表</strong></div>
            </div>
                ...
                <div class="am-u-sm-12 am-u-md-3">
                    <div class="am-form-group">
                        <select data-am-selected="{btnSize: 'sm'}">
                            <option value="option1">所有组</option>
                            <option value="option2">www.jsh315.com</option>
                            <option value="option3">model.jsh315.com</option>
                            <option value="option3">weixin.jsh315.com</option>
                ...
                <div class="am-u-sm-12">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <td class="am-hide-sm-only">www.jsh315.com_master</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td><a href="#">www.jsh315.com_mysql</a></td>
                            <td class="am-hide-sm-only"><span class="am-badge am-badge-success">正常</span></td>
                            <td>
                                <div class="am-progress">
                                    <div class="am-progress-bar-success" style="width: 0.36%">0.36%</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="am-progress">
                                    <div class="am-progress-bar-danger" style="width: 85%">85%</div>
                                </div>
                            </td>
                            <td class="am-hide-sm-only">www.jsh315.com_master</td>
                            <td class="am-hide-sm-only">2016年09月6日 7:28:47</td>
